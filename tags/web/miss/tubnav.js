...
window.addEvent('domready', function(){
	...
	var mySlide = new Fx.Slide('tubmenu');
	var myMenu =  new Fx.Slide('toggle');
	...
	$('tubmenu').addEvent('mouseleave', function(e){
		e = new Event(e);
		mySlide.slideOut();
		myMenu.slideIn();
		e.stop();
	...
	$('demomenu').addEvent('mouseleave', function(e){
		e = new Event(e);
		mySlide.slideOut();
		myMenu.slideIn();
		e.stop();
...
function onM(obj,no){
	obj.src=adres + "/tubitak-bar2_0" + no + ".jpg";
}

function outM(obj,no){
...
document.write('} ');
document.write('#ustserit img { ');
document.write('	border:0px; ');
document.write('	} ');
document.write('#altserit, #altserit a{ ');
document.write('	font-family: verdana; ');
document.write('	font-size:9px; ');
document.write('	color:white; ');
document.write('} ');
document.write('#demomenu img {');
document.write('	border:0px;');
document.write('}');
document.write('</style>');
...
document.write('<table width="731" height="78" border="0" cellpadding="0" cellspacing="0">');
document.write('	<tr>');
document.write('		<td>');
document.write('			<a href="http://www.uekae.tubitak.gov.tr"><img src="' +adres+ '/tubitak-bar_01.jpg" width="350" height="78" alt="" /></a></td>');
document.write('		<td>');
document.write('			<a href="http://www.akiskart.com.tr"><img src="' +adres+ '/tubitak-bar_02.jpg" width="76" height="78" alt="" onmouseover="onM(this,2)" onmouseout="outM(this,2)" /></a></td>');
document.write('		<td>');
document.write('			<a href="http://www.pardus.org.tr"><img src="' +adres+ '/tubitak-bar_03.jpg" width="76" height="78" alt="" onmouseover="onM(this,3)" onmouseout="outM(this,3)" /></a></td>');
document.write('		<td>');
document.write('			<a href="http://www.kamusm.gov.tr"><img src="' +adres+ '/tubitak-bar_04.jpg" width="76" height="78" alt="" onmouseover="onM(this,4)" onmouseout="outM(this,4)" /></a></td>');
document.write('		<td>');
document.write('			<a href="http://www.iltaren.tubitak.gov.tr"><img src="' +adres+ '/tubitak-bar_05.jpg" width="76" height="78" alt="" onmouseover="onM(this,5)" onmouseout="outM(this,5)" /></a></td>');
document.write('		<td>');
document.write('			<a href="http://www.bilgiguvenligi.gov.tr"><img src="' +adres+ '/tubitak-bar_06.jpg" width="77" height="78" alt="" onmouseover="onM(this,6)" onmouseout="outM(this,6)" /></a></td>');
document.write('	</tr>');

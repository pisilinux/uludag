...
mod_name = 'Display Configuration'
mod_app = 'display-config'
mod_version = '0.1'
...
def AboutData():
    return KAboutData(
        ...
        mod_name,
        mod_version,
        I18N_NOOP('Display Configuration'),
...
def main():
    ...
    if not KUniqueApplication.start():
        print i18n('Display Configuration is already started!')
        return

    kapp = KUniqueApplication(True, True, True)
    win = QDialog()
    win.setCaption(i18n('Display Configuration'))

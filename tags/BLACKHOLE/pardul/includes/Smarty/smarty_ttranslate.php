...
function ngettextDB ($text) {
	global $Lisan;
	$text  = addslashes($text);
 	$Sorgu = sorgula("SELECT $Lisan FROM lang_templates WHERE tr='$text'");
	while(list($vt_Text) = $Sorgu->fetchRow()) {
		$text = stripslashes($vt_Text);
// 		echo $vt_Text;
		return $text;
	}
}

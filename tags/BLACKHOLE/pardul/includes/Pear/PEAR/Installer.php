...
// +----------------------------------------------------------------------+
//
// $Id: Installer.php,v 1.38.2.2 2002/04/09 19:04:22 ssb Exp $

require_once "$KutuphaneDizin/Pear/PEAR/Common.php";
require_once "$KutuphaneDizin/Pear/PEAR/Registry.php";
require_once "$KutuphaneDizin/Pear/PEAR/Dependency.php";

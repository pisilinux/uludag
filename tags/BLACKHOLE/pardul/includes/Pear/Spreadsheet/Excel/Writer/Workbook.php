...
require_once("$KutuphaneDizin/Pear/Spreadsheet/Excel/Writer/Format.php");
require_once("$KutuphaneDizin/Pear/Spreadsheet/Excel/Writer/BIFFwriter.php");
require_once("$KutuphaneDizin/Pear/Spreadsheet/Excel/Writer/Worksheet.php");
require_once("$KutuphaneDizin/Pear/Spreadsheet/Excel/Writer/Parser.php");
require_once("$KutuphaneDizin/Pear/OLE/PPS/Root.php");
require_once("$KutuphaneDizin/Pear/OLE/PPS/File.php");
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    {
	global $KutuphaneDizin;
        include_once("$KutuphaneDizin/Pear/Spreadsheet/Excel/Writer/Validator.php");

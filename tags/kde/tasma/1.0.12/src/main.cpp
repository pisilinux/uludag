...
int main( int argc, char *argv[] )
{
  ...
  KAboutData aboutData( "tasma", I18N_NOOP( "TASMA - Pardus Configuration Center" ), "1.0.12",
  ...
  aboutData.addAuthor( "Barış Metin", I18N_NOOP( "Old Maintainer & Original Author" ), "baris@uludag.org.tr" );

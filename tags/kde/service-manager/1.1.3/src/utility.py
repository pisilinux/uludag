...
def getIcon(name, size=32):
    return KGlobal.iconLoader().loadIcon(name, KIcon.Desktop, size)

def getIconSet(name, size=32):
    return KGlobal.iconLoader().loadIconSet(name, KIcon.Desktop, size)

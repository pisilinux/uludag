...
/**
 * Genel metin ara�lar�. String benzerli�i, Q klavye mesafesi gibi fonksiyonlar� bar�nd�r�r
 * @author MDA
 */
public class MetinAraclari {
    ...
    /**
     * Degistirilmis Levenshtein Edit Dist. algoritmas�. transpozisyonlar� da 1 d�zeltme mesafesi
     * olarak hesaplar.
     *
     * @param source
     * @param target
    ...
    public static final int editDistance(String source, String target) {
    ...
    /**
     * Degistirilmis Levenshtein Edit Dist. algoritmas�. transpozisyonlar� da 1
     * d�zeltme mesafesi olarak hesaplar.
     *
     * @param source
     * @param target
    ...
    /**
     * verilen s1 stringinin verilen distance d�zeltme mesafesi �er�evesinde
     * s2 stringinin alt stringi olup olmad���n� d�nd�r�r. �rne�in:
     * <pre>
     ...
     *
     * @param s1       :
     * @param s2       : s1'i distance d�zeltme mesafesi i�inde kapsay� kapsamad��� ara�t�r�lan String
     * @param distance : d�zeltme mesafesi
     * @return eger istenilen mesafede is true.
     */

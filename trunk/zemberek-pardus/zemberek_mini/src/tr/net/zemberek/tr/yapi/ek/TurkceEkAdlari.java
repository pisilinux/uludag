 ...
 * Date: Feb 12, 2006
 */
public class TurkceEkAdlari {

    public static final String BOS_EK = "BOS_EK";
    public static final String ISIM_YALIN_BOS = "ISIM_YALIN_BOS";
    public static final String FIIL_YALIN_BOS = "FIIL_YALIN_BOS";
    public static final String SAYI_YALIN_BOS = "SAYI_YALIN_BOS";
    public static final String ZAMAN_YALIN_BOS = "ZAMAN_YALIN_BOS";
    public static final String ZAMIR_YALIN_BOS = "ZAMIR_YALIN_BOS";
    public static final String GENEL_YALIN_BOS = "GENEL_YALIN_BOS";
    public static final String UNLEM_YALIN_BOS = "UNLEM_YALIN_BOS";
    public static final String EDAT_YALIN_BOS = "EDAT_YALIN_BOS";
    public static final String BAGLAC_YALIN_BOS = "BAGLAC_YALIN_BOS";
    public static final String OZEL_YALIN_BOS = "OZEL_YALIN_BOS";
    public static final String IMEK_YALIN_BOS = "IMEK_YALIN_BOS";
    public static final String YANKI_YALIN_BOS = "YANKI_YALIN_BOS";
    public static final String SORU_YALIN_BOS = "SORU_YALIN_BOS";
    ...
    public static final String FIIL_SORU_MI = "FIIL_SORU_MI";

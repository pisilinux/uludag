...
class Runner:
    ...
    def __init__(self):
        ...
        install_type = YALI_LIVEINSTALL #Changed default to Yali-live
    ...
    def run(self):
        ...
        #In Yali-Live mode, run as yali as window
    ...
    def _init_screen(self, screen = 0):
        # We want it to be a full-screen window or normal window with specific size
        # inside the primary display.
        scr = self._app.desktop().screenGeometry()
        window_size =  self._window.geometry()
        ...
        if screen == 0:
            ...
            self._window.move((scr.width()-window_size.width())/2, (scr.height()-window_size.height())/2)

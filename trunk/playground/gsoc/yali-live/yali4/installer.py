...
import yali4.gui.ScrLiveInstall
...
class Yali:
    def __init__(self, install_type=YALI_INSTALL, install_plugin=None):
        ...
        self._screens[YALI_LIVEINSTALL] = [                              # Numbers can be used with -s paramter
                                       ...
                                       yali4.gui.ScrPartitionAuto,       # 06
                                       yali4.gui.ScrPartitionManual,     # 07
                                       yali4.gui.ScrBootloader,          # 08
                                       yali4.gui.ScrSummary,             # 09
                                       yali4.gui.ScrLiveInstall,         # 10

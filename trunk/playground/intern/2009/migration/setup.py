...
app_data = [
("migration", ["migration/migration.py", "migration/migration-users.py", "migration/wizard.py", "migration/applythread.py", "migration/migration.png"]),
...
kdedistutils.setup(
    ...
    executable_links = [("migration", "migration/migration.py"),("migration-users", "migration/migration-users.py")],
